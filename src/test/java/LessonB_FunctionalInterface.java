...
public class LessonB_FunctionalInterface {
    ...
    public void _1_introducingTheDefaultKeyword() {
        ...
        assertThat(comparator.compare(x, y)).isEqualTo(____);
        assertThat(comparator.reverseCompare(x, y)).isEqualTo(____);
    }
...
//    @FunctionalInterface
    ...
    static class MyAwesomeInteger implements MyInteger, MyLoggingInteger {
        ...
        /**
         * Delete this method once you have completed the exercise for MyInteger.
         */
        @Override
    ...
    public void _2_multipleInheritance() {
        ...
        assertThat(i).isInstanceOf(______);
        assertThat(i).isInstanceOf(______);
        assertThat(i.subtract(2)).isEqualTo(____);
    }
